...
public class LepidophloiosTrunkPlacer extends TrunkPlacer {
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader levelSimulatedReader, BiConsumer<BlockPos, BlockState> biConsumer,
        ...
        //North:
        placeLog(pos.offset(0, height  , -1), logState);
        placeLog(pos.offset(0, height  , -2), logState);
        placeLog(pos.offset(0, height +1, -3), logState);
        placeLog(pos.offset(0, height +2, -1), logState);
        placeLog(pos.offset(0, height +2 , -4), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , -4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-2, height , -4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(0, height , -6), 0, true));
        placeLog(pos.offset(0, height +3 , -1), logState);
        placeLog(pos.offset(0, height +3, -4), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(1, height , -4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , -4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-1, height , -4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-2, height , -4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(0, height , -5), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(0, height , -6), 0, true));
        placeLog(pos.offset(0, height +4 , -1), logState);
        placeLog(pos.offset(0, height +5, -1), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-2, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(0, height , -4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(1, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-1, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-2, height , -2), 0, true));
...
//South:
        ...
        placeLog(pos.offset(0, height , 2), logState);
        placeLog(pos.offset(0, height +1, 3), logState);
        placeLog(pos.offset(1, height , 1), logState);
        placeLog(pos.offset(0, height , 4), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , 4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-2, height , 4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(0, height , 6), 0, true));
        placeLog(pos.offset(0, height +1,  2), logState);
        placeLog(pos.offset(0, height , 4), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(1, height , 4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , 4), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(-1, height , 4), 0, true));
        ...
        placeLog(pos.offset(1, height , 1), logState);
        placeLog(pos.offset(0, height , 4), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(4, height , 2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(4, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(6, height , 0), 0, true));
        placeLog(pos.offset(2, height +1,  0), logState);
        placeLog(pos.offset(4, height , 0), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(4, height , 1), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(4, height , 2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(4, height , -1), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(4, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(5, height , 0), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(6, height , 0), 0, true));
        placeLog(pos.offset(2, height +1, 0), logState);
        placeLog(pos.offset(2, height +1, 0), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , 2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , -2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(4, height , 0), 0, true));
        placeLog(pos.offset(2, height +1, 0), logState);
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , 1), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , 2), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , -1), 0, true));
        list.add(new FoliagePlacer.FoliageAttachment(pos.offset(2, height , 2), 0, true));
