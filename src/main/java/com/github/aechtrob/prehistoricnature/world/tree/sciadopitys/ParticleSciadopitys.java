...
public class ParticleSciadopitys extends FallingLeavesParticle {
    
    public ParticleSciadopitys(ClientLevel level, double x, double y, double z, SpriteSet sprites, float gravityMultiplier, float windBig, boolean swirl, boolean flowAway, float size, float ySpeed) {
        super(level, x, y, z, sprites, gravityMultiplier, windBig, swirl, flowAway, size, ySpeed);
    }

    public static class SciadopitysProvider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public SciadopitysProvider(SpriteSet spriteSet) {
