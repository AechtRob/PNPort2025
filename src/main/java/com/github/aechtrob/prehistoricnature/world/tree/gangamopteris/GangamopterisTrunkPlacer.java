...
public class GangamopterisTrunkPlacer extends TrunkPlacer {
    ...
    public static final Codec<GangamopterisTrunkPlacer> CODEC = RecordCodecBuilder.create((instance) -> {
        return trunkPlacerParts(instance).apply(instance, GangamopterisTrunkPlacer::new);
    });
