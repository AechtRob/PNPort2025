...
public class PNTrunkPlacerType {
    ...
    public static DeferredHolder<TrunkPlacerType<?>, TrunkPlacerType<?>> LEPTOPHLOEUM_TRUNK_PLACER = TRUNK_PLACER_TYPES.register("leptophloeum_trunk_placer", () -> new TrunkPlacerType<>(LeptophloeumTrunkPlacer.CODEC));
