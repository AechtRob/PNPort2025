...
public class LeptophloeumFoliagePlacer extends BlobFoliagePlacer {
    public LeptophloeumFoliagePlacer(IntProvider p_161356_, IntProvider p_161357_, int p_161358_) {
    ...
    public static final MapCodec<BlobFoliagePlacer> CODEC =
            RecordCodecBuilder.mapCodec((p_68427_) ->
                    blobParts(p_68427_).apply(p_68427_, LeptophloeumFoliagePlacer::new));

    @Override
    protected FoliagePlacerType<?> type() {
        return PNFoliagePlacerType.LEPTOPHLOEUM_FOLIAGE_PLACER_HOLDER.get();
    }

    BlockState leafState = BlocksTreeLeptophloeum.LEPTOPHLOEUM_LEAVES.get().defaultBlockState();
