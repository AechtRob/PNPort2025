...
public class LepidophloiosFoliagePlacer extends BlobFoliagePlacer {
    public LepidophloiosFoliagePlacer(IntProvider p_161356_, IntProvider p_161357_, int p_161358_) {
    ...
    public static final MapCodec<BlobFoliagePlacer> CODEC =
            RecordCodecBuilder.mapCodec((p_68427_) ->
                    blobParts(p_68427_).apply(p_68427_, LepidophloiosFoliagePlacer::new));

    @Override
    protected FoliagePlacerType<?> type() {
        return PNFoliagePlacerType.LEPIDOPHLOIOS_FOLIAGE_PLACER_HOLDER.get();
    }

    BlockState leafState = BlocksTreeLepidophloios.LEPIDOPHLOIOS_LEAVES.get().defaultBlockState();
    BlockState strobilusState = BlocksTreeLepidophloios.LEPIDOPHLOIOS_STROBILUS.get().defaultBlockState().setValue(PNDecayableDirectional.PERSISTENT, false);
