...
public class PitysFoliagePlacer extends BlobFoliagePlacer {
    public PitysFoliagePlacer(IntProvider p_161356_, IntProvider p_161357_, int p_161358_) {
    ...
    public static final MapCodec<BlobFoliagePlacer> CODEC =
            RecordCodecBuilder.mapCodec((p_68427_) ->
                    blobParts(p_68427_).apply(p_68427_, PitysFoliagePlacer::new));

    @Override
    protected FoliagePlacerType<?> type() {
        return PNFoliagePlacerType.PITYS_FOLIAGE_PLACER_HOLDER.get();
    }

    BlockState leafState = BlocksTreePitys.PITYS_LEAVES.get().defaultBlockState();
    BlockState strobilusState = BlocksTreePitys.PITYS_STROBILUS.get().defaultBlockState().setValue(PNDecayableDirectional.PERSISTENT, false);
