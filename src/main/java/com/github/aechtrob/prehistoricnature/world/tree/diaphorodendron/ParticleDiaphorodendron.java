...
public class ParticleDiaphorodendron extends FallingLeavesParticle {
    
    public ParticleDiaphorodendron(ClientLevel level, double x, double y, double z, SpriteSet sprites, float gravityMultiplier, float windBig, boolean swirl, boolean flowAway, float size, float ySpeed) {
        super(level, x, y, z, sprites, gravityMultiplier, windBig, swirl, flowAway, size, ySpeed);
    }

    public static class DiaphorodendronProvider implements ParticleProvider<SimpleParticleType> {
        private final SpriteSet spriteSet;

        public DiaphorodendronProvider(SpriteSet spriteSet) {
