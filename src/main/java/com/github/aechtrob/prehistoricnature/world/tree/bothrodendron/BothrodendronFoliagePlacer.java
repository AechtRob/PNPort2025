...
public class BothrodendronFoliagePlacer extends BlobFoliagePlacer {
    public BothrodendronFoliagePlacer(IntProvider p_161356_, IntProvider p_161357_, int p_161358_) {
    ...
    public static final MapCodec<BlobFoliagePlacer> CODEC =
            RecordCodecBuilder.mapCodec((p_68427_) ->
                    blobParts(p_68427_).apply(p_68427_, BothrodendronFoliagePlacer::new));

    @Override
    protected FoliagePlacerType<?> type() {
        return PNFoliagePlacerType.BOTHRODENDRON_FOLIAGE_PLACER_HOLDER.get();
    }

    BlockState leafState = BlocksTreeBothrodendron.BOTHRODENDRON_LEAVES.get().defaultBlockState();
    BlockState strobilusState = BlocksTreeBothrodendron.BOTHRODENDRON_STROBILUS.get().defaultBlockState().setValue(PNDecayableDirectional.PERSISTENT, false);
