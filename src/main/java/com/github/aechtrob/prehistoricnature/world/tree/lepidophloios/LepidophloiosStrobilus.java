...
public class LepidophloiosStrobilus extends PNDecayableDirectional implements IEnvelopable {
    ...
    public ItemStack envelopeMimicsItemPlacement() {
        return new ItemStack(BlocksTreeLepidophloios.LEPIDOPHLOIOS_SAPLING.get(), 1);
    }
