...
public class DiaphorodendronFoliagePlacer extends BlobFoliagePlacer {
    ...
    public static final MapCodec<BlobFoliagePlacer> CODEC =
            RecordCodecBuilder.mapCodec((p_68427_) ->
                    blobParts(p_68427_).apply(p_68427_, DiaphorodendronFoliagePlacer::new));

    @Override
    protected FoliagePlacerType<?> type() {
        return PNFoliagePlacerType.DIAPHORODENDRON_FOLIAGE_PLACER_HOLDER.get();
    }

    BlockState leafState = BlocksTreeDiaphorodendron.DIAPHORODENDRON_LEAVES.get().defaultBlockState();
    BlockState strobilusState = BlocksTreeDiaphorodendron.DIAPHORODENDRON_STROBILUS.get().defaultBlockState().setValue(PNDecayableDirectional.PERSISTENT, false);
