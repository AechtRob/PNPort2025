...
public class GlossopterisATrunkPlacer extends TrunkPlacer {
    ...
    public GlossopterisATrunkPlacer(int p_70268_, int p_70269_, int p_70270_) {
        super(p_70268_, p_70269_, p_70270_);
    }

    public static final Codec<GlossopterisATrunkPlacer> CODEC = RecordCodecBuilder.create((instance) -> {
        return trunkPlacerParts(instance).apply(instance, GlossopterisATrunkPlacer::new);
    });
    ...
    protected TrunkPlacerType<?> type() {
        return PNTrunkPlacerType.GLOSSOPTERISA_TRUNK_PLACER.get();
    }
    ...
    public List<FoliagePlacer.FoliageAttachment> placeTrunk(LevelSimulatedReader levelSimulatedReader, BiConsumer<BlockPos, BlockState> biConsumer,
        ...
        int height = 0;
        BlockState logState = BlocksTreeGlossopterisA.GLOSSOPTERISA_LOG.get().defaultBlockState().setValue(PNTreeLogBlock.AXIS,Direction.Axis.Y);
        BlockState woodState = BlocksTreeGlossopterisA.GLOSSOPTERISA_WOOD.get().defaultBlockState().setValue(PNTreeLogBlock.AXIS,Direction.Axis.Y);
