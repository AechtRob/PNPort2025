...
public class SynchysidendronFoliagePlacer extends BlobFoliagePlacer {
    public SynchysidendronFoliagePlacer(IntProvider p_161356_, IntProvider p_161357_, int p_161358_) {
    ...
    public static final MapCodec<BlobFoliagePlacer> CODEC =
            RecordCodecBuilder.mapCodec((p_68427_) ->
                    blobParts(p_68427_).apply(p_68427_, SynchysidendronFoliagePlacer::new));

    @Override
    protected FoliagePlacerType<?> type() {
        return PNFoliagePlacerType.SYNCHYSIDENDRON_FOLIAGE_PLACER_HOLDER.get();
    }

    BlockState leafState = BlocksTreeSynchysidendron.SYNCHYSIDENDRON_LEAVES.get().defaultBlockState();
    BlockState strobilusState = BlocksTreeSynchysidendron.SYNCHYSIDENDRON_STROBILUS.get().defaultBlockState().setValue(PNDecayableDirectional.PERSISTENT, false);
