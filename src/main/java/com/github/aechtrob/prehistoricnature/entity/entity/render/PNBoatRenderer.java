...
public class PNBoatRenderer extends AbstractBoatRenderer {
    private final Model waterPatchModel;
    private final ResourceLocation texture;
    private final EntityModel<BoatRenderState> model;

    public PNBoatRenderer(EntityRendererProvider.Context context, ModelLayerLocation modelLayer, String boatName) {
        super(context);
        this.texture = modelLayer.model().withPath((p_375447_) -> "textures/entity/boat/" + boatName + ".png");
