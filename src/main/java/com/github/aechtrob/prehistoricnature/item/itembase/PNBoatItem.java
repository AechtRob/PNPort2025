...
public class PNBoatItem extends Item {
    ...
    public PNBoatItem(boolean pHasChest, ModBoatEntity.Type pType, Item.Properties pProperties) {
        super(pProperties);
    ...
    private Boat getBoat(Level level, HitResult p_220018_) {
        return (Boat)(this.hasChest ? new ModChestBoatEntity(level, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z) :
                new ModBoatEntity(level, p_220018_.getLocation().x, p_220018_.getLocation().y, p_220018_.getLocation().z));
    }
}