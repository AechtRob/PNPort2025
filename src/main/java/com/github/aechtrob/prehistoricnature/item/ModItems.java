...
public class ModItems {
    ...
    public static final DeferredItem<Item> COLLECTION_ENVELOPE = ITEMS.register("collection_envelope",
            () -> new PNCollectionEnvelope(new Item.Properties().stacksTo(64).setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(PrehistoricNature.MODID, "collection_envelope")))));
